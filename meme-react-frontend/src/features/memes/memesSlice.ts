...
import { fetchCount } from './memesAPI';
...
// in the slice file. For example: `useSelector((state: RootState) => state.memes.value)`
export const selectCount = (state: RootState) => state.memes.value;
